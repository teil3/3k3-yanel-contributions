/*
 * Copyright 2016 litwan, teil
 */

package com.litwan.yanel.impl.resources.tinymce4;
 ...
 */
public class TinyMCE4Resource extends ExecutableUsecaseResource {
    
    private static Logger log = Logger.getLogger(TinyMCE4Resource.class);
